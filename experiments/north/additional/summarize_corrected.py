...
result={}
names=('exact_host','exact_joint','exact_async','prepared_async','original_async')
for prompt in args['prompts']:
    ...
    contrasts['prepared_over_async']=contrast(values['prepared_async'],values['exact_async'])
    contrasts['prepared_over_joint']=contrast(values['prepared_async'],values['exact_joint'])
    contrasts['prepared_over_original_async']=contrast(values['prepared_async'],values['original_async'])
    contrasts['async_over_joint']=contrast(values['exact_async'],values['exact_joint'])
