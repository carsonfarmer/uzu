...
manifest=json.loads((Path(__file__).parent/'results/model-provenance.json').read_text())
...
source_manifest=json.loads((Path(__file__).parent/'results/source-provenance.json').read_text())
