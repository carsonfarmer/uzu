"""Isolate task ordering and cross-branch fusion in the existing exact control.
...
def run_branch(data, scores, residual, mode):
    ...
    attention = split_attention(
        inputs=data, grid=(64 * 256, 1, 1), threadgroup=(256, 1, 1),
...
def main():
    ...
    save({
        ...
        "design": {
            ...
            "comparison_limit": "Separate-vs-mixed changes launch count and grid/resource scheduling together. It does not isolate launch overhead from simultaneous execution or register-resource effects.",
        },
    })
